...
import main.TestSessionBean.FirstEJB;
import main.TestSessionBean.SecondEJB;
...
//    @EJB
//    public TestSessionBean testBean;
//    public boolean beanStatus;
//    public String beanMsg;

//    EJB
    @Inject
    public ClientTest ejbClient;
    /**
    ...
    @Min(value = 0, message = "\tMoney cannot be negative")
    private float money;
    ...
    public LSEA(String nick, String password, String name, String surname, int age, float money) {
        this.nick = nick;
        ...
        this.age = age;
        this.money = money;
//        this.beanStatus = this.testBean.getBeanStatus();
//        this.beanMsg = this.testBean.getMsg();
    }
//    @PostConstruct
//    public boolean test(){
